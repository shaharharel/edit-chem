"""
Base classes for data extraction across all modalities.

This provides a common interface for extracting paired data from various sources:
- Small molecules: ChEMBL, PubChem, etc.
- Antibodies: SAbDab, OAS, etc.
- RNA: RNAcentral, Rfam, etc.
"""
...
class PairDataExtractor(ABC):
    ...
    2. Generate pairs (e.g., MMPs for molecules, mutations for antibodies)
