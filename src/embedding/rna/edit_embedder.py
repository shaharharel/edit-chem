...
Parallel to src/embedding/small_molecule/edit_embedder.py, this computes
edit embeddings for RNA sequences as:
...
class RNAEditEmbedder:
    ...
    **Two Modes:**
    ...
    - Compatible with EditEffectPredictor from the small molecule framework
    ...
    Example:
        >>> from src.embedding.rna import NucleotideEmbedder, RNAEditEmbedder
    ...
    def _extract_local_context(
        ...
        """
        from ...data.rna.sequence_utils import extract_edit
    ...
    def _compute_edit_features(
        ...
        """
        from ...data.rna.sequence_utils import (
...
class TrainableRNAEditEmbedder:
    ...
    Similar to the TrainableEditEmbedder in the small molecule framework,
    this learns to transform (seq_a_emb, seq_b_emb) → edit_emb through
