...
(small molecules, antibodies, RNA, etc.)
"""
...
class BaselinePropertyPredictor:
    ...
    This is a molecule-agnostic approach that works with any pre-computed embeddings:
    - Small molecules: SMILES → ChemBERTa/Fingerprint → embedding
    - Antibodies: sequences → IgBert/IgT5 → embedding
    - RNA: sequences → UTR-LM → embedding
